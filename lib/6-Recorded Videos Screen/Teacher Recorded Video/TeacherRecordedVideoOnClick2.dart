...
class TeacherRecordedOnClick2 extends StatefulWidget {
  const TeacherRecordedOnClick2({ Key? key, required this.videouplod,required this.videouploadList }) : super(key: key);

  final SavePython videouplod;
  final List<SavePython> videouploadList;

  @override
  State<TeacherRecordedOnClick2> createState() => _TeacherRecordedOnClick2State();
}

class _TeacherRecordedOnClick2State extends State<TeacherRecordedOnClick2> {
  ...
  updateStatus() async {
    ...
    var response = await http.post(Uri.parse(ApiUrl.apiUrl + 'meyepro/api/SavePython2/HideVideo'),
      body:{
    ...
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Hide Successfully!"),));
  ...
  Widget build(BuildContext context) {
    ...
    // HIDE BUTTON //
    final hideButton = AnimatedContainer(
      ...
      child: Material(
        ...
        child: MaterialButton(
          ...
          child: const Text("Hide This Video",textAlign: TextAlign.center,
            style: TextStyle(
