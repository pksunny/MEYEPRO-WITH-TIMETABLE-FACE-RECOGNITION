...
class TeacherRecordedOnClick extends StatefulWidget {
  const TeacherRecordedOnClick({ Key? key, required this.videouplod,required this.videouploadList }) : super(key: key);

  final SavePython videouplod;
  final List<SavePython> videouploadList;

  @override
  State<TeacherRecordedOnClick> createState() => _TeacherRecordedOnClickState();
}

class _TeacherRecordedOnClickState extends State<TeacherRecordedOnClick> {
