...
class TeacherRecordedVideo extends StatefulWidget {
  const TeacherRecordedVideo({ Key? key }) : super(key: key);

  @override
  State<TeacherRecordedVideo> createState() => _TeacherRecordedVideoState();
}

class _TeacherRecordedVideoState extends State<TeacherRecordedVideo> {
  ...
  Future<void> getPythonVideo() async{
    var response=await http.get(Uri.parse(ApiUrl.apiUrl + 'meyepro/api/SavePython/getPythonVideo'));
            ...
            itemBuilder: (context,index){
              ...
              return InkWell(
                onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => TeacherRecordedOnClick(videouplod: videouploadList[index], videouploadList:data,)));
