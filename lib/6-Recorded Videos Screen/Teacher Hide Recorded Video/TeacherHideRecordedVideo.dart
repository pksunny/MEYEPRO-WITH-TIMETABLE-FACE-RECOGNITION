...
class TeacherHideRecordedVideo extends StatefulWidget {
  const TeacherHideRecordedVideo({ Key? key }) : super(key: key);

  @override
  State<TeacherHideRecordedVideo> createState() => _TeacherHideRecordedVideoState();
}

class _TeacherHideRecordedVideoState extends State<TeacherHideRecordedVideo> {
  ...
  Future<void> getPythonVideo() async{
    var response=await http.get(Uri.parse(ApiUrl.apiUrl + 'meyepro/api/SavePython/getHidePythonVideo'));
            ...
            itemBuilder: (context,index){
              ...
              return InkWell(
                onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => TeacherHideRecordedOnClick(videouplod: videouploadList[index], videouploadList:data,)));
