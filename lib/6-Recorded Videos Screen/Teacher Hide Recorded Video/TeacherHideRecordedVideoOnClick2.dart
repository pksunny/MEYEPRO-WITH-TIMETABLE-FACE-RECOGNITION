...
class TeacherHideRecordedOnClick2 extends StatefulWidget {
  const TeacherHideRecordedOnClick2({ Key? key, required this.videouplod,required this.videouploadList }) : super(key: key);

  final SavePython videouplod;
  final List<SavePython> videouploadList;

  @override
  State<TeacherHideRecordedOnClick2> createState() => _TeacherHideRecordedOnClick2State();
}

class _TeacherHideRecordedOnClick2State extends State<TeacherHideRecordedOnClick2> {
