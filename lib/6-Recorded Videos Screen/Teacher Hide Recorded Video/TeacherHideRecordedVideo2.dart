...
import 'package:m_eye_gui/6-Recorded%20Videos%20Screen/Teacher%20Hide%20Recorded%20Video/TeacherHideRecordedVideoOnClick.dart';
import 'package:m_eye_gui/6-Recorded%20Videos%20Screen/Teacher%20Hide%20Recorded%20Video/TeacherHideRecordedVideoOnClick2.dart';
...
class TeacherHideRecordedVideo2 extends StatefulWidget {
  const TeacherHideRecordedVideo2({ Key? key }) : super(key: key);

  @override
  State<TeacherHideRecordedVideo2> createState() => _TeacherHideRecordedVideo2State();
}

class _TeacherHideRecordedVideo2State extends State<TeacherHideRecordedVideo2> {
  ...
  Future<void> getPythonVideo() async{
    var response=await http.get(Uri.parse(ApiUrl.apiUrl + 'meyepro/api/SavePython2/getHidePythonVideo?teachername=' + name1.toString()));
            ...
            itemBuilder: (context,index){
              ...
              return InkWell(
                onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => TeacherHideRecordedOnClick2(videouplod: videouploadList[index], videouploadList:data,)));
