...
class TeacherSelectedOnClickCheckBox extends StatefulWidget {
  const TeacherSelectedOnClickCheckBox({ Key? key, required this.selectedOverall,required this.selectedTimeTable }) : super(key: key);
  ...
  @override
  State<TeacherSelectedOnClickCheckBox> createState() => _TeacherSelectedOnClickCheckBoxState();
}

class _TeacherSelectedOnClickCheckBoxState extends State<TeacherSelectedOnClickCheckBox> {
