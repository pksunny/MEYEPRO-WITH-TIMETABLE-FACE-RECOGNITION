...
class SectionMakeUpOnClickCheckBox extends StatefulWidget {
  const SectionMakeUpOnClickCheckBox({ Key? key, required this.selectedOverall,required this.selectedTimeTable }) : super(key: key);

  final MakeUpClass selectedOverall;
  final List<MakeUpClass> selectedTimeTable;

  @override
  State<SectionMakeUpOnClickCheckBox> createState() => _SectionMakeUpOnClickCheckBoxState();
}

class _SectionMakeUpOnClickCheckBoxState extends State<SectionMakeUpOnClickCheckBox> {
